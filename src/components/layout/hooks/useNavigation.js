...
export function useNavigation() {
  ...
  const navigationItems = ref([
    ...
    { key: 'alternativeSourcing', label: '国产替代寻源', path: '/user/demands/DomesticSourcing', queryParams: { type: 'alternativeSourcing'}, basePath: '/demand-square' },
    { key: 'originalSourcing', label: '原厂件寻源', path: '/user/demands/OEMPartsSourcing', queryParams: { type: 'originalSourcing'}, basePath: '/demand-square' },
    { key: 'rndCollaboration', label: '研发攻关', path: '/user/demands/PublicRelations', queryParams: { type: 'rndCollaboration'}, basePath: '/demand-square' },
    { key: 'testingValidation', label: '检测验证', path: '/user/demands/Verification', queryParams: { type: 'testingValidation'}, basePath: '/demand-square' },
