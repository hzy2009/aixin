...
export function useNavigation() {
  ...
  const navigationItems = ref([
    ...
    { key: 'alternativeSourcing', label: '国产替代寻源', path: '/demands/DomesticSourcing', queryParams: { type: 'alternativeSourcing'}, basePath: '/demand-square' },
    { key: 'originalSourcing', label: '原厂件寻源', path: '/demands/OEMPartsSourcing', queryParams: { type: 'originalSourcing'}, basePath: '/demand-square' },
    { key: 'rndCollaboration', label: '研发攻关', path: '/demands/PublicRelations', queryParams: { type: 'rndCollaboration'}, basePath: '/demand-square' },
    { key: 'testingValidation', label: '检测验证', path: '/demands/Verification', queryParams: { type: 'testingValidation'}, basePath: '/demand-square' },
