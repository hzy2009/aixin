...
.basic-info-grid { gap: @spacing-sm @spacing-lg; font-size: 14px; .info-grid-item { display: flex; padding: @spacing-md 0; font-family: PingFang SC; font-weight: 400; font-size: 14px; line-height: 22px; } .info-grid-label { display: flex; justify-content: right; align-items: center; color: @text-color-secondary; margin-right: @spacing-xs; white-space: nowrap; min-width: 120px; text-align: right; } .info-grid-value {align-items: center; color: #272A30; word-break: break-word; flex: 1; width: calc(100% - 120px); } }
