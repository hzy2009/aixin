<template>
  <div class="page-tabs-container">
    <div class="container">
      <a-tabs :activeKey="activeKey" @change="onTabChange" class="main-category-tabs">
        <a-tab-pane v-for="tab in tabs" :key="tab.key" :tab="tab.label"></a-tab-pane>
      </a-tabs>
    </div>
  </div>
</template>
...
defineProps({
  tabs: {
    type: Array,
    required: true,
    default: () => [] // e.g., [{ key: 'domestic', label: '国产替代寻源' }, ...]
  },
  activeKey: {
    type: String,
    required: true
