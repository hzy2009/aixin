...
const rdDynamicRoutes = [
  {
    ...
    meta: { title: '定制开发动态 - 爱芯享电子信息服务平台', requiresAuth: false, requiresSecondaryVerification: true }
  },
  {
    path: '/rd-dynamics/:id',
    ...
    meta: { title: '动态详情 - 爱芯享电子信息服务平台', requiresAuth: true, roles: ['apm-vip', 'apm-vip-inspection', 'apm-register', 'apm-register-expert'] }
  }
];
