  ...
  children: [
    {
    ...
    },
     {
      ...
      meta: { title: '需求详情', breadcrumb: ['需求详情'] }
    },
    {
      ...
      meta: { title: '新建需求', breadcrumb: ['新建需求'] }
    },
    {
    ...
    
    {
      ...
      meta: { title: '新建研发公关', breadcrumb: ['新建研发公关'] }
    },
    {
      ...
      meta: { title: '研发公关详情', breadcrumb: [ '研发公关详情'] }
    },
    {
      path: 'Verification',
      name: 'Verification',
    ...
    },
     {
      ...
      meta: { title: '新建检验验证', breadcrumb: [ '新建检验验证'] }
    },
     {
      ...
      meta: { title: '检验验证详情', breadcrumb: [ '检验验证详情'] }
    },
