...
const tableColumns2 = [
  ...
  { title: '零部件料号/设备名称', field: 'partNumber', align: 'center' },
  ...
  { title: '卖方', field: 'postedBy', align: 'center', formatter: postedBy, width: 100 }, 
  { field: 'refUserName', title: '买方', align: 'center', formatter: postedBy, width: 100 }, 
