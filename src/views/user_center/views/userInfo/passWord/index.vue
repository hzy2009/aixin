...
const validatePass = async (_rule, value) => {
	...
	if (!passwordRegex.test(value)) {
		return Promise.reject('密码必须至少8位，且包含大小写字母、数字和符号');
	} else {
...
// // --- 表单配置 ---
const formConfigs = [
	{ label: '原密码', field: 'oldpassword', span: 24, fieldType: 'password', rules: [{ required: true, validator: validatePass, trigger: 'change' }], tips: '密码由8位以上的英文字母、数字和符号组成，英文字母需含大小写' },
	{
